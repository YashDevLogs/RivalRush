...
public sealed class PlayerModel : MonoBehaviour
{
    ...
    public float WallClingEndTime { get; set; }
    public float WallClingNormalX { get; set; }
    public float LastGroundTime { get; set; } = -999f;
    public float LastJumpPressTime { get; set; } = -999f;
    public float NextAllowedGroundCheckTime { get; set; }
